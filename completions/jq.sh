...
# @flag --arg                        name value  set $name to the string value;
# @flag --argjson                    name value  set $name to the JSON value;
# @flag --slurpfile                  name file set $name to an array of JSON values read from the file;
# @flag --rawfile                    name file  set $name to string contents of file;
