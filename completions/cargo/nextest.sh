...
# @option --show-progress <SHOW_PROGRESS>        Show list progress in the specified manner.
...
# {{ cargo nextest run
# @cmd Build and run tests [alias: r]
# @option --color <WHEN>                         Produce color output: auto, always, never
# @flag --no-pager                               Do not pipe output through a pager
# @flag -v --verbose                             Verbose output
# @flag -h --help                                Print help (see a summary with '-h')
...
# {{ cargo nextest bench
# @cmd Build and run benchmarks (experimental) [alias: b]
# @option --color <WHEN>                         Produce color output: auto, always, never
# @flag --no-pager                               Do not pipe output through a pager
# @flag -v --verbose                             Verbose output
# @flag -h --help                                Print help (see a summary with '-h')
...
# @cmd This version of nextest does not have self-update enabled
# @option --color <WHEN>                        Produce color output: auto, always, never
# @flag --no-pager                              Do not pipe output through a pager
# @flag -v --verbose                            Verbose output
