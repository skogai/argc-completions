...
# @flag -U --defined-only                Display only defined symbols
...
# @flag -W --no-weak                     Ignore weak symbols
# @flag --without-symbol-versions        Do not display version strings after symbol names
