...
# @flag -J                                selects JSON output mode.
# @flag -j                                selects JSON Lines output mode.
...
# @flag -P                                inhibits the conversion of port numbers to port names for network files (the mapping is commonly learned from /etc/services).
