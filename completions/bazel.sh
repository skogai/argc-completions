...
# @option --bazelrc <string>           may be used multiple times
# @flag --block_for_lock
# @flag --noblock_for_lock
# @flag --client_debug
# @flag --noclient_debug
# @option --connect_timeout_secs <integer>
# @option --digest_function <value>    hash function
# @option --experimental_cgroup_parent <string>
# @flag --experimental_run_in_user_cgroup
# @flag --noexperimental_run_in_user_cgroup
# @option --extra_classpath <string>
...
# @flag --workspace_rc
# @flag --noworkspace_rc
# @flag --experimental_remote_repo_contents_cache
# @flag --noexperimental_remote_repo_contents_cache
...
# @option --http_connector_attempts <integer>
# @option --http_connector_retry_max_timeout <value>  An immutable length of time.
# @option --http_max_parallel_downloads <integer>
# @option --http_timeout_scaling <double>
# @option --repo_contents_cache <path>
# @option --repo_contents_cache_gc_idle_delay <value>  An immutable length of time.
# @option --repo_contents_cache_gc_max_age <value>  An immutable length of time.
# @option --repository_cache <path>
# @flag --repository_disable_download
# @flag --norepository_disable_download
# @flag --allow_one_action_on_resource_unavailable
# @flag --noallow_one_action_on_resource_unavailable
# @option --allowed_strategies_by_exec_platform <value>  a '<Label>=value[,value]' assignment may be used multiple times
...
# @flag --experimental_async_execution
# @flag --noexperimental_async_execution
# @option --experimental_async_execution_max_concurrent_actions <integer>
...
# @flag --experimental_inmemory_sandbox_stashes
# @flag --noexperimental_inmemory_sandbox_stashes
# @flag --experimental_persistent_aar_extractor
# @flag --noexperimental_persistent_aar_extractor
...
# @option --experimental_sandbox_enforce_resources_regexp <value>  a valid Java regular expression
# @option --experimental_sandbox_limits[HOST_CPUS|HOST_RAM] <value>  a named double, 'name=value', where value is an integer, or a keyword, optionally followed by an operation ([-|*]<float>) eg.
# @option --experimental_sandbox_memory_limit_mb <value>  an integer number of MBs, or "HOST_RAM", optionally followed by [-|*]<float>.
# @flag --experimental_shrink_worker_pool
# @flag --noexperimental_shrink_worker_pool
...
# @option --experimental_total_worker_memory_limit_mb <value>  an integer number of MBs, or "HOST_RAM", optionally followed by [-|*]<float>.
...
# @option --experimental_worker_allowlist <value>  comma-separated set of options
# @flag --experimental_worker_cancellation
# @flag --noexperimental_worker_cancellation
# @option --experimental_worker_memory_limit_mb <value>  an integer number of MBs, or "HOST_RAM", optionally followed by [-|*]<float>.
# @option --experimental_worker_metrics_poll_interval <value>  An immutable length of time.
# @flag --experimental_worker_multiplex_sandboxing
# @flag --noexperimental_worker_multiplex_sandboxing
# @flag --experimental_worker_sandbox_hardening
# @flag --noexperimental_worker_sandbox_hardening
# @option --experimental_worker_sandbox_inmemory_tracking <string>  may be used multiple times
# @flag --experimental_worker_strict_flagfiles
# @flag --noexperimental_worker_strict_flagfiles
# @option --gc_churning_threshold <value>          an integer in 0-100 range
# @option --gc_churning_threshold_if_multiple_top_level_targets <integer>
# @option --gc_thrashing_threshold <value>         an integer in 0-100 range
# @option --genrule_strategy <value>               comma-separated list of options
# @flag --incompatible_modify_execution_info_additive
# @flag --noincompatible_modify_execution_info_additive
# @flag --incompatible_use_new_cgroup_implementation
# @flag --noincompatible_use_new_cgroup_implementation
...
# @option --modify_execution_info* <regex=[+-]key,regex=[+-]key,>  may be used multiple times
...
# @flag --sandbox_enable_loopback_device
# @flag --nosandbox_enable_loopback_device
...
# @flag --skip_incompatible_explicit_targets
# @flag --noskip_incompatible_explicit_targets
...
# @flag --use_target_platform_for_tests
# @flag --nouse_target_platform_for_tests
...
# @flag --worker_multiplex
# @flag --noworker_multiplex
...
# @option --extra_execution_platforms <value>      comma-separated list of options
...
# @flag --noincompatible_bazel_test_exec_run_under
# @flag --incompatible_builtin_objc_strip_action
# @flag --noincompatible_builtin_objc_strip_action
...
# @flag --incompatible_strip_executable_safely
# @flag --noincompatible_strip_executable_safely
...
# @option --platform_mappings <path>               a main workspace-relative path
...
# @flag --use_platforms_in_apple_crosstool_transition
# @flag --nouse_platforms_in_apple_crosstool_transition
...
# @option --cc_proto_library_header_suffixes <value>  comma-separated set of options
# @option --cc_proto_library_source_suffixes <value>  comma-separated set of options
...
# @flag --incompatible_compact_repo_mapping_manifest
# @flag --noincompatible_compact_repo_mapping_manifest
# @option --incompatible_disable_select_on <value>  comma-separated set of options
# @flag --incompatible_filegroup_runfiles_for_data
# @flag --noincompatible_filegroup_runfiles_for_data
...
# @flag --save_temps
# @flag --nosave_temps
# @option --serialized_frontier_profile <string>
# @option --action_env <value>                     a 'name[=value]' assignment with an optional value part or the special syntax '=name' to unset a variable may be used multiple times
# @option --allowed_cpu_values <value>             comma-separated set of options
...
# @flag --enable_propeller_optimize_absolute_paths
# @flag --noenable_propeller_optimize_absolute_paths
# @flag --enable_remaining_fdo_absolute_paths
# @flag --noenable_remaining_fdo_absolute_paths
# @option --enable_runfiles[auto|yes|no] <value>   a tri-state
# @option --noenable_runfiles[auto|yes|no] <value>  a tri-state
# @option --exec_aspects <value>                   comma-separated list of options may be used multiple times
...
# @option --experimental_output_paths[off|strip]
# @option --experimental_override_platform_cpu_name <value>  a 'label=value' assignment may be used multiple times
# @option --experimental_platform_in_output_dir[auto|yes|no] <value>  a tri-state
# @option --noexperimental_platform_in_output_dir[auto|yes|no] <value>  a tri-state
# @flag --experimental_py_binaries_include_label
# @flag --noexperimental_py_binaries_include_label
# @flag --experimental_strict_repo_env
# @flag --noexperimental_strict_repo_env
# @flag --experimental_use_llvm_covmap
# @flag --noexperimental_use_llvm_covmap
# @flag --experimental_use_platforms_in_output_dir_legacy_heuristic
# @flag --noexperimental_use_platforms_in_output_dir_legacy_heuristic
# @flag --fat_apk_hwasan
...
# @flag --force_pic
# @flag --noforce_pic
# @option --host_action_env <value>                a 'name[=value]' assignment with an optional value part or the special syntax '=name' to unset a variable may be used multiple times
...
# @flag --noincompatible_auto_exec_groups
...
# @flag --noincompatible_repo_env_ignores_action_env
# @flag --incompatible_target_cpu_from_platform
# @flag --noincompatible_target_cpu_from_platform
...
# @option --memprof_profile[`_choice_target`] <label>
...
# @option --repo_env <value>                       a 'name[=value]' assignment with an optional value part or the special syntax '=name' to unset a variable may be used multiple times
...
# @flag --allow_experimental_loads
# @flag --noallow_experimental_loads
...
# @flag --experimental_enforce_transitive_visibility
# @flag --noexperimental_enforce_transitive_visibility
# @option --experimental_one_version_enforcement[off|warning|error]
...
# @option --incompatible_enforce_starlark_utf8[off|warning|error]
# @option --noincompatible_enforce_starlark_utf8[off|warning|error]
# @flag --incompatible_validate_top_level_header_inclusions
# @flag --noincompatible_validate_top_level_header_inclusions
# @flag --one_version_enforcement_on_java_tests
# @flag --noone_version_enforcement_on_java_tests
# @option --python_native_rules_allowlist[`_choice_target`] <label>
...
# @flag --experimental_dormant_deps
# @flag --noexperimental_dormant_deps
...
# @flag --noexperimental_enable_first_class_macros
# @flag --experimental_enable_scl_dialect
# @flag --noexperimental_enable_scl_dialect
# @flag --experimental_enable_starlark_set
# @flag --noexperimental_enable_starlark_set
...
# @flag --noexperimental_repository_ctx_execute_wasm
...
# @flag --noexperimental_single_package_toolchain_binding
# @flag --experimental_starlark_type_checking
# @flag --noexperimental_starlark_type_checking
# @flag --experimental_starlark_type_syntax
# @flag --noexperimental_starlark_type_syntax
# @option --experimental_starlark_types_allowed_paths <value>  comma-separated list of options
# @flag --force_starlark_stack_trace
# @flag --noforce_starlark_stack_trace
# @flag --incompatible_allow_tags_propagation
# @flag --noincompatible_allow_tags_propagation
# @flag --incompatible_always_check_depset_elements
# @flag --noincompatible_always_check_depset_elements
# @option --incompatible_autoload_externally <value>  comma-separated set of options
# @flag --incompatible_check_external_repo_source_dir_package_boundary
# @flag --noincompatible_check_external_repo_source_dir_package_boundary
...
# @flag --noincompatible_disable_autoloads_in_main_repo
...
# @flag --incompatible_disable_target_default_provider_fields
# @flag --noincompatible_disable_target_default_provider_fields
# @option --incompatible_disable_transitions_on <value>  comma-separated set of options
# @flag --incompatible_disallow_ctx_resolve_tools
# @flag --noincompatible_disallow_ctx_resolve_tools
...
# @flag --noincompatible_disallow_sdk_frameworks_attributes
...
# @flag --noincompatible_locations_prefers_executable
...
# @flag --incompatible_no_implicit_watch_label
# @flag --noincompatible_no_implicit_watch_label
# @flag --incompatible_no_rule_outputs_param
# @flag --noincompatible_no_rule_outputs_param
# @flag --incompatible_objc_alwayslink_by_default
# @flag --noincompatible_objc_alwayslink_by_default
# @flag --incompatible_package_group_has_public_syntax
# @flag --noincompatible_package_group_has_public_syntax
# @flag --incompatible_python_disallow_native_rules
# @flag --noincompatible_python_disallow_native_rules
# @flag --incompatible_resolve_select_keys_eagerly
# @flag --noincompatible_resolve_select_keys_eagerly
# @flag --incompatible_run_shell_command_string
# @flag --noincompatible_run_shell_command_string
# @flag --incompatible_simplify_unconditional_selects_in_rule_attrs
# @flag --noincompatible_simplify_unconditional_selects_in_rule_attrs
# @flag --incompatible_stop_exporting_build_file_path
# @flag --noincompatible_stop_exporting_build_file_path
...
# @option --repositories_without_autoloads <value>  comma-separated set of options
...
# @option --default_test_resources <value>         a resource name followed by equal and 1 float or 4 float, e.g memory=10,30,60,100 may be used multiple times
...
# @option --test_env <value>                       a 'name[=value]' assignment with an optional value part or the special syntax '=name' to unset a variable may be used multiple times
...
# @flag --noexperimental_explicit_aspects
# @flag --graph:factored
...
# @flag --include_pruned_inputs
# @flag --noinclude_pruned_inputs
...
# @flag --proto:include_attribute_source_aspects
# @flag --noproto:include_attribute_source_aspects
# @flag --proto:include_starlark_rule_env
# @flag --noproto:include_starlark_rule_env
...
# @flag --proto:rule_classes
# @flag --noproto:rule_classes
...
# @option --lockfile_mode[off|update|refresh|error]
# @option --module_mirrors <value>                 a '[name=]value1[,..,valueN]' assignment may be used multiple times
...
# @option --vendor_dir <path>
# @option --cache_computed_file_digests <value>    a long integer
# @flag --cc_dotd_files
# @flag --nocc_dotd_files
# @flag --cc_include_scanning
# @flag --nocc_include_scanning
# @option --experimental_active_directories <value>  comma-separated list of options
# @flag --experimental_cpu_load_scheduling
# @flag --noexperimental_cpu_load_scheduling
# @option --experimental_dynamic_ignore_local_signals <value>  a comma-separated list of signal numbers
# @flag --experimental_enable_skyfocus
# @flag --noexperimental_enable_skyfocus
...
# @option --gc_thrashing_limits <value>            comma separated pairs of <period>:<count>
# @flag --heuristically_drop_nodes
# @flag --noheuristically_drop_nodes
...
# @option --local_resources[HOST_CPUS|HOST_RAM] <value>  a named double, 'name=value', where value is an integer, or a keyword, optionally followed by an operation ([-|*]<float>) eg.
...
# @option --skyframe_high_water_mark_full_gc_drops_per_invocation <value>  an integer, >= 0
# @option --skyframe_high_water_mark_minor_gc_drops_per_invocation <value>  an integer, >= 0
...
# @option --bes_system_keywords <value>            comma-separated list of options may be used multiple times
# @option --bes_timeout <value>                    An immutable length of time.
# @option --bes_upload_mode[wait_for_upload_complete|nowait_for_upload_complete|fully_async]
...
# @option --build_event_binary_file_upload_mode[wait_for_upload_complete|nowait_for_upload_complete|fully_async]
...
# @option --build_event_json_file_upload_mode[wait_for_upload_complete|nowait_for_upload_complete|fully_async]
...
# @option --build_event_text_file_upload_mode[wait_for_upload_complete|nowait_for_upload_complete|fully_async]
# @option --build_event_upload_max_retries <integer>
...
# @option --experimental_build_event_output_group_mode <value>  an output group name followed by an OutputGroupFileMode, e.g. default=both may be used multiple times
...
# @flag --experimental_collect_load_average_in_profiler
# @flag --noexperimental_collect_load_average_in_profiler
# @flag --experimental_collect_pressure_stall_indicators
# @flag --noexperimental_collect_pressure_stall_indicators
# @flag --experimental_collect_resource_estimation
# @flag --noexperimental_collect_resource_estimation
# @flag --experimental_collect_skyframe_counts_in_profiler
# @flag --noexperimental_collect_skyframe_counts_in_profiler
# @flag --experimental_collect_system_network_usage
# @flag --noexperimental_collect_system_network_usage
# @flag --experimental_collect_worker_data_in_profiler
# @flag --noexperimental_collect_worker_data_in_profiler
# @option --experimental_command_profile[cpu|wall|alloc|lock]
# @flag --experimental_docker_verbose
# @flag --noexperimental_docker_verbose
# @option --experimental_frontier_violation_check[strict|warn|disabled_for_testing]
# @flag --experimental_frontier_violation_verbose
# @flag --noexperimental_frontier_violation_verbose
...
# @flag --noexperimental_profile_include_target_configuration
...
# @flag --noexperimental_record_skyframe_metrics
# @flag --experimental_run_bep_event_include_residue
# @flag --noexperimental_run_bep_event_include_residue
# @option --experimental_skyfocus_dump_keys[none|count|verbose]
# @flag --experimental_skyfocus_dump_post_gc_stats
# @flag --noexperimental_skyfocus_dump_post_gc_stats
...
# @option --jvm_heap_histogram_internal_object_pattern <value>  a valid Java regular expression
...
# @option --profile <path>
# @option --profiles_to_retain <integer>
# @option --progress_report_interval <value>       an integer in 0-3600 range
# @flag --record_full_profiler_data
# @flag --norecord_full_profiler_data
# @flag --redirect_local_instrumentation_output_writes
# @flag --noredirect_local_instrumentation_output_writes
# @option --remote_analysis_json_log <string>
...
# @option --test_summary[short|short_uncached|terse|detailed|detailed_uncached|none|testcase]
...
# @flag --verbose_visibility_errors
# @flag --noverbose_visibility_errors
# @flag --write_command_log
# @flag --nowrite_command_log
# @option --aspects_parameters <value>             a 'name=value' assignment may be used multiple times
# @option --flag_alias <value>                     a 'name=label' flag alias may be used multiple times
...
# @option --downloader_config <path>
# @option --experimental_circuit_breaker_strategy <failure>
# @flag --experimental_remote_cache_chunking
# @flag --noexperimental_remote_cache_chunking
# @option --experimental_remote_cache_compression_threshold <integer>
# @option --experimental_remote_cache_eviction_retries <integer>
# @flag --experimental_remote_cache_lease_extension
# @flag --noexperimental_remote_cache_lease_extension
# @option --experimental_remote_cache_ttl <value>  An immutable length of time.
...
# @flag --noexperimental_remote_downloader_propagate_credentials
...
# @option --experimental_remote_output_service <string>
# @option --experimental_remote_output_service_output_path_prefix <string>
# @flag --experimental_remote_require_cached
# @flag --noexperimental_remote_require_cached
# @option --experimental_remote_scrubbing_config <value>  Converts to a Scrubber
# @option --guard_against_concurrent_changes[off|lite|full]
# @option --noguard_against_concurrent_changes[off|lite|full]
# @flag --incompatible_remote_local_fallback_for_remote_cache
# @flag --noincompatible_remote_local_fallback_for_remote_cache
# @flag --remote_accept_cached
# @flag --noremote_accept_cached
# @option --remote_build_event_upload[all|minimal]
# @option --remote_bytestream_uri_prefix <string>
# @option --remote_cache <string>
# @flag --remote_cache_async
# @flag --noremote_cache_async
# @flag --remote_cache_compression
# @flag --noremote_cache_compression
...
# @option --remote_download_regex <value>          a valid Java regular expression may be used multiple times
...
# @option --remote_max_concurrency_per_connection <integer>
...
# @flag --rewind_lost_inputs
# @flag --norewind_lost_inputs
...
# @option --deleted_packages <value>               comma-separated list of package names may be used multiple times
...
# @option --execution_log_compact_file <path>
...
# @option --experimental_action_cache_gc_idle_delay <value>  An immutable length of time.
# @option --experimental_action_cache_gc_max_age <value>  An immutable length of time.
# @option --experimental_action_cache_gc_threshold <value>  an integer in 0-100 range
# @option --experimental_cancel_concurrent_tests[never|on_failed|on_passed]
# @option --noexperimental_cancel_concurrent_tests[never|on_failed|on_passed]
# @option --experimental_disk_cache_gc_idle_delay <value>  An immutable length of time.
# @option --experimental_disk_cache_gc_max_age <value>  An immutable length of time.
# @option --experimental_disk_cache_gc_max_size <value>  a size in bytes, optionally followed by a K, M, G or T multiplier
# @flag --experimental_enable_thread_dump
# @flag --noexperimental_enable_thread_dump
...
# @option --experimental_install_base_gc_max_age <value>  An immutable length of time.
# @option --experimental_java_classpath[off|javabuilder|bazel|bazel_no_fallback]
# @flag --experimental_rule_extension_api
# @flag --noexperimental_rule_extension_api
...
# @option --experimental_thread_dump_action_execution_inactivity_duration <value>  An immutable length of time.
# @option --experimental_thread_dump_interval <value>  An immutable length of time.
...
# @flag --grpc_tcp_keepalive
# @flag --nogrpc_tcp_keepalive
# @option --grpc_tcp_keepalive_count <integer>
# @option --grpc_tcp_keepalive_interval <value>    An immutable length of time.
# @option --grpc_tcp_keepalive_time <value>        An immutable length of time.
...
# @flag --noincompatible_disable_non_executable_java_binary
...
# @option --inject_repository <path>               an equals-separated mapping of repository name to path may be used multiple times
# @option --invocation_id <UUID>
...
# @option --optimizing_dexer[`_choice_target`] <label>
...
# @flag --proto_profile
# @flag --noproto_profile
# @option --proto_profile_path[`_choice_target`] <label>
...
# @option --test_sharding_strategy <value>         explicit, disabled or forced=k where k is the number of shards to enforce
# @option --test_size_filters <small|medium|large|or enormous>  comma-separated list of values
# @option --test_tag_filters <value>               comma-separated list of options
# @option --test_timeout_filters <short|moderate|long|or eternal>  comma-separated list of values
...
# @option --cc_proto_library_header_suffixes <value>  comma-separated set of options
# @option --cc_proto_library_source_suffixes <value>  comma-separated set of options
# @flag --experimental_include_default_values
# @flag --noexperimental_include_default_values
# @flag --experimental_proto_descriptor_sets_include_source_info
# @flag --noexperimental_proto_descriptor_sets_include_source_info
# @flag --experimental_save_feature_state
# @flag --noexperimental_save_feature_state
...
# @flag --action_cache
# @flag --noaction_cache
# @option --memory <value>                         memory mode
# @flag --packages
# @flag --nopackages
# @flag --rule_classes
# @flag --norule_classes
# @flag --rules
# @flag --norules
# @option --skyframe[off|summary|count|value|deps|rdeps|function_graph|active_directories|active_directories_frontier_deps]
...
# @option --override_module <path>                 an equals-separated mapping of module name to path may be used multiple times
# @option --registry <string>                      may be used multiple times
# @option --repo <string>                          may be used multiple times
# @option --vendor_dir <path>
# @option --cache_computed_file_digests <value>    a long integer
# @flag --cc_dotd_files
# @flag --nocc_dotd_files
...
# @flag --incompatible_target_cpu_from_platform
# @flag --noincompatible_target_cpu_from_platform
# @option --info_output_type[stdout|response_proto]
# @flag --instrument_test_targets
# @flag --noinstrument_test_targets
# @option --instrumentation_filter <path>          a comma-separated list of regex expressions with prefix '-' specifying excluded paths
# @option --ios_minimum_os <value>                 a dotted version (for example '2.3' or '3.3alpha2.4')
...
# @flag --all_repos
# @flag --noall_repos
# @flag --all_visible_repos
# @flag --noall_visible_repos
...
# @option --output[text|json|graph|streamed_proto|streamed_jsonproto]
# @flag --verbose
# @flag --noverbose
# @option --allow_yanked_versions <string>         may be used multiple times
# @option --check_bazel_compatibility[error|warning|off]
...
# @flag --watchfs
# @flag --nowatchfs
# @arg tidy-query_type <tidy|<query_type>>
# @arg args*
mod() {
    :;
}
...
# @flag --run
# @flag --norun
# @option --run_env <value>                        a 'name[=value]' assignment with an optional value part or the special syntax '=name' to unset a variable may be used multiple times
# @flag --run_in_cwd
# @flag --norun_in_cwd
# @flag --allow_one_action_on_resource_unavailable
# @flag --noallow_one_action_on_resource_unavailable
...
# {{ bazel vendor
# @cmd Fetches external repositories into a folder specified by the flag --vendor_dir.
# @option --distdir <path>                         may be used multiple times
# @flag --experimental_repository_cache_hardlinks
# @flag --noexperimental_repository_cache_hardlinks
# @option --experimental_repository_downloader_retries <integer>
