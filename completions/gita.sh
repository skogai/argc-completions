...
# @flag -h --help       show this help message and exit
# @option -s --shell    If set, run in shell mode
# @arg worktrunk-cli-gita-argc-completions-chezmoi-skogai-claude-mem-skogai-tools-config-src <worktrunk,cli,gita,argc-completions,chezmoi,skogai,claude-mem,skogai,tools,config,src,[]>  fetch remote update for all repos or for the chosen repo(s) or group(s)
fetch() {
    :;
}
# }} gita fetch
...
# @flag -h --help       show this help message and exit
# @option -s --shell    If set, run in shell mode
# @arg worktrunk-cli-gita-argc-completions-chezmoi-skogai-claude-mem-skogai-tools-config-src <worktrunk,cli,gita,argc-completions,chezmoi,skogai,claude-mem,skogai,tools,config,src,[]>  show one-line log for the latest 7 commits for all repos or for the chosen repo(s) or group(s)
lo() {
    :;
}
# }} gita lo
...
# @flag -h --help       show this help message and exit
# @option -s --shell    If set, run in shell mode
# @arg worktrunk-cli-gita-argc-completions-chezmoi-skogai-claude-mem-skogai-tools-config-src <worktrunk,cli,gita,argc-completions,chezmoi,skogai,claude-mem,skogai,tools,config,src,[]>  pull remote updates for all repos or for the chosen repo(s) or group(s)
pull() {
    :;
}
# }} gita pull
...
# @flag -h --help       show this help message and exit
# @option -s --shell    If set, run in shell mode
# @arg worktrunk-cli-gita-argc-completions-chezmoi-skogai-claude-mem-skogai-tools-config-src <worktrunk,cli,gita,argc-completions,chezmoi,skogai,claude-mem,skogai,tools,config,src,[]>  push the local updates for all repos or for the chosen repo(s) or group(s)
push() {
    :;
}
# }} gita push
...
# @flag -h --help       show this help message and exit
# @option -s --shell    If set, run in shell mode
# @arg worktrunk-cli-gita-argc-completions-chezmoi-skogai-claude-mem-skogai-tools-config-src <worktrunk,cli,gita,argc-completions,chezmoi,skogai,claude-mem,skogai,tools,config,src,[]>  show edit statistics for all repos or for the chosen repo(s) or group(s)
stat() {
    :;
}
# }} gita stat
...
# @flag -h --help       show this help message and exit
# @option -s --shell    If set, run in shell mode
# @arg worktrunk-cli-gita-argc-completions-chezmoi-skogai-claude-mem-skogai-tools-config-src <worktrunk,cli,gita,argc-completions,chezmoi,skogai,claude-mem,skogai,tools,config,src,[]>  show status for all repos or for the chosen repo(s) or group(s)
st() {
    :;
}
# }} gita st
