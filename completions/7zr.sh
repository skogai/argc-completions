...
# @option -ai <[r[-|0]][m[-|2]][w[-]]{@listfile|!wildcard}>  Include archives
# @option -ax <[r[-|0]][m[-|2]][w[-]]{@listfile|!wildcard}>  eXclude archives
...
# @option -i <[r[-|0]][m[-|2]][w[-]]{@listfile|!wildcard}>  Include filenames
...
# @option -r <-|0>                      Recurse subdirectories for name search
# @option -sa-[a|e|s]                   set Archive name mode
# @option -scc[UTF-8|WIN|DOS]           set charset for console input/output
...
# @option -spf <2>                      use fully qualified file paths
# @flag -ssc                            set sensitive case mode
# @flag -sse                            stop archive creating, if it can't open some input file
# @flag -ssp                            do not change Last Access Time of source files while archiving
...
# @option -x <[r[-|0]][m[-|2]][w[-]]{@listfile|!wildcard}>  eXclude filenames
