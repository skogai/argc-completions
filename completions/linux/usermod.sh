...
# @flag -b --badname                              allow bad names
...
# @flag -r --remove                               remove the user from only the supplemental GROUPS mentioned by the -G option without removing the user from other groups
