...
# @option --param-index <number>           parameter index (default 0)
...
# @option -f --rtc <file>                  use an alternate file to /dev/rtc
# @flag --directisa                        use the ISA bus instead of /dev/rtc access
