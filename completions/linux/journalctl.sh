...
# @option --root <DIR>                      Operate on an alternate filesystem root
# @option --image <FILE>                    Operate on disk image as filesystem root
# @option --image-policy <POLICY>           Specify disk image dissection policy
# @option --namespace                       Show journal data from specified journal namespace
...
# @option --invocation <ID>                 Show logs from the matching invocation ID
# @flag -I                                  Show logs from the latest invocation of unit
# @option -t --identifier <ID>              Show entries with the specified syslog identifier
# @option -T --exclude-identifier <ID>      Hide entries with the specified syslog identifier
# @option -p --priority[`_choice_priority`] <RANGE>  Show entries within the specified priority range
# @option --facility*,[`_choice_facility`] <FACILITY…>  Show entries with the specified facilities
...
# @flag --truncate-newline                  Truncate entries by first newline character
# @flag -q --quiet                          Do not show info messages and privilege warning
# @option --synchronize-on-exit <BOOL>      Wait for Journal synchronization before exiting
...
# @flag --list-invocations                  Show invocation IDs of specified unit
# @flag --list-namespaces                   Show list of journal namespaces
