...
# @flag -J --json                   display in JSON format mode
...
# @option --lastlog-file <path>     set an alternate path for lastlog
# @option --lastlog2-file <path>    set an alternate path for lastlog2
