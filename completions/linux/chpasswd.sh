...
# @option -c --crypt-method[`_choice_crypt_method`] <METHOD>  the crypt method (one of NONE DES MD5 SHA256 SHA512 YESCRYPT)
...
# @flag -s --sha-rounds               number of rounds for the SHA, BCRYPT or YESCRYPT crypt algorithms
