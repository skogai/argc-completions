...
# @flag -b                   binary digit dump (incompatible with -ps).
...
# @flag -t                   append terminating zero to C include output (-i).
...
# @flag -v                   show version: "xxd 2026-04-26 by Juergen Weigert et al.".
# @arg intpufile
# @arg outputfile
